<?php namespace App\Http\Controllers;
	...
	class AdminPalabrasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Palabra","name"=>"palabra"];
			$this->col[] = ["label"=>"Dificultad Id","name"=>"dificultad_id","join"=>"dificultad,dificultad"];
